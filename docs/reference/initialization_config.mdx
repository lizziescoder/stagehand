...
const stagehand = new Stagehand({
	env: "LOCAL",
	// env: "BROWSERBASE", // For remote Browser sessions (needs API keys)
	verbose: 1,
	enableCaching: true,
    ...
    // LLM configuration
    modelName: "name-of-model", /* Name of the model to use */
    modelClientOptions: {
...
<ParamField path="env" type="'LOCAL' | 'BROWSERBASE'">
...
<ParamField path="browserbaseSessionCreateParams" type="object">
...
<ParamField path="browserbaseSessionID" type="string">
  ID of an existing Browserbase session to resume
</ParamField>

<ParamField path="modelName" type="AvailableModel">
  Specifying the default language model to use
</ParamField>

<ParamField path="modelClientOptions" type="object">
  Configuration options for the language model client (i.e. `apiKey`)
</ParamField>

<ParamField path="enableCaching" type="boolean">
...
<ParamField path="disablePino" type="boolean">
...
<ParamField path="selfHeal" type="boolean">
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="recordHar" type="object">
      <Expandable title="properties">
        ...
        <ResponseField name="mode" type='"full" | "minimal"'>
          Mode for HAR recording.
        </ResponseField>
        <ResponseField name="omitContent" type="boolean">
          Whether to omit content in HAR recording.
        </ResponseField>
        <ResponseField name="content" type='"omit" | "embed" | "attach"'>
          Content mode for HAR recording.
        </ResponseField>
        <ResponseField name="urlFilter" type="string | RegExp">
