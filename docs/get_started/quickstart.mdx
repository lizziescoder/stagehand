...
If you prefer Python, you can get started with Stagehand Python SDK:

<Steps>
<Step title="Prerequisites">
   Before you begin, you'll need Python 3.8+ installed. We recommend using [pyenv](https://github.com/pyenv/pyenv) to manage your Python versions.
</Step>
...
<Step title="Create and run your first script">
