...
<Steps>
  ...
  <Step title="Create a new project">
    ...
    For quick deployment on [Vercel](https://vercel.com/), run:
    ...
    To use Computer Use Agents (CUA, Operator), run:
...
<CardGroup cols={2}>
  <Card title="Check out the scaffold repo" icon="github" href="https://github.com/browserbase/stagehand-scaffold">
  ...
  <Card title="Check out the CLI repo" icon="github" href="https://github.com/browserbase/create-browser-app">
