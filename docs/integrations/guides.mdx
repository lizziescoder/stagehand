...
Check out the [Python examples repository](https://github.com/browserbase/stagehand-python-examples) to see how to use Stagehand with Python, including async/sync patterns and agent usage.

You can also explore the [CrewAI integration](/integrations/crew-ai) for building AI agent workflows with Python.
